    ...
    recordEscrowPlan(jobId, plan) {
      ...
      job.chain = {
        ...
        escrow: {
          ...
          redeemScriptHex: plan.redeemScriptHex ?? null,
          scriptLength: plan.scriptLength ?? null,
          entrypoints: plan.entrypoints ?? null,
          compileValidated: plan.compileValidated ?? null,
          escrowAddress: plan.escrowAddress ?? null,
          addressDerive: plan.addressDerive ?? null,
